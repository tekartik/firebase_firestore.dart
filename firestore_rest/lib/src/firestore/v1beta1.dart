...
library firestore_googleapis.firestore.v1beta1;
...
class ProjectsDatabasesResourceApi {
  ...
  ProjectsDatabasesIndexesResourceApi get indexes =>
      ProjectsDatabasesIndexesResourceApi(_requester);
...
class ProjectsDatabasesIndexesResourceApi {
  ...
  async.Future<GoogleFirestoreAdminV1beta1Index> get(core.String name,
    ...
    var _response = _requester.request(_url, "GET",
        ...
        downloadOptions: _downloadOptions);
    return _response
        .then((data) => GoogleFirestoreAdminV1beta1Index.fromJson(data));
  }
  ...
  async.Future<GoogleFirestoreAdminV1beta1ListIndexesResponse> list(
    ...
    return _response.then((data) =>
        GoogleFirestoreAdminV1beta1ListIndexesResponse.fromJson(data));
  }
}
...
class GoogleFirestoreAdminV1beta1ExportDocumentsMetadata {
  ...
  GoogleFirestoreAdminV1beta1ExportDocumentsMetadata.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("progressBytes")) {
      progressBytes =
          GoogleFirestoreAdminV1beta1Progress.fromJson(_json["progressBytes"]);
    }
    if (_json.containsKey("progressDocuments")) {
      progressDocuments = GoogleFirestoreAdminV1beta1Progress.fromJson(
  ...
  GoogleFirestoreAdminV1beta1Index.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("fields")) {
      fields = (_json["fields"] as core.List)
          .map<GoogleFirestoreAdminV1beta1IndexField>(
              (value) => GoogleFirestoreAdminV1beta1IndexField.fromJson(value))
          .toList();
    }
    if (_json.containsKey("name")) {
      name = _json["name"];
...
class GoogleFirestoreAdminV1beta1IndexOperationMetadata {
  ...
  GoogleFirestoreAdminV1beta1IndexOperationMetadata.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("documentProgress")) {
      documentProgress = GoogleFirestoreAdminV1beta1Progress.fromJson(
    ...
    if (_json.containsKey("indexes")) {
      indexes = (_json["indexes"] as core.List)
          .map<GoogleFirestoreAdminV1beta1Index>(
              (value) => GoogleFirestoreAdminV1beta1Index.fromJson(value))
          .toList();
    }
