...
void main() {
  group('utils', () {
    ...
    test('comparableList', () {
      ...
      expect(
        ComparableList([2]).compareTo(ComparableList([1])),
        greaterThan(0),
      );
      expect(
        ComparableList([1]).compareTo(ComparableList([1, 0])),
        lessThan(0),
      );
      expect(
        ComparableList([1, 0]).compareTo(ComparableList([1])),
        greaterThan(0),
      );
    });
    test('comparableMap', () {
      ...
      expect(
        ComparableMap({'test': 0}).compareTo(ComparableMap({'test': 0})),
        0,
      );
      expect(
        ComparableMap({'test': 0}).compareTo(ComparableMap({'test': 1})),
        lessThan(0),
      );
      expect(
        ComparableMap({'test': 1}).compareTo(ComparableMap({'test': 0})),
        greaterThan(0),
      );
      expect(
        ComparableMap({
      ...
      expect(
        ComparableMap({'other': 2}).compareTo(ComparableMap({'test': 1})),
        lessThan(0),
      );
      // inner list
      expect(
    ...
    test('mapQueryInfo', () {
      ...
      DocumentSnapshotBase newSnapshot(String id, int value) {
        return DocumentSnapshotMock(
          ...
          documentData: DocumentDataMap(map: <String, Object?>{'value': value}),
        );
      }
    ...
    test('FirestoreDocumentInfo', () {
      ...
      var firestoreDocumentInfo = FirestoreDocumentInfo(
        data: documentData,
        path: 'some/path',
      );
